  ...
  return (
    <header className="shadow-md">
      <div className="mx-auto flex max-w-7xl items-center justify-between px-4 py-4 sm:px-8">
        <Link to="/">
          <h2 className="text-primary-400 text-2xl font-bold">AirB</h2>
        </Link>
        <div className="hidden items-center rounded-full border border-gray-300 px-4 py-2 shadow-md lg:flex">
          ...
          <p className="px-4">Procura</p>
          <div className="bg-primary-400 cursor-pointer rounded-full p-2 text-white">
            <svg
